...
class preprocess(object):
    ...
    def __init__(self, data_root, seq_name, parser, log, split='train', phase='training'):
        ...
        if parser.dataset == 'nuscenes_pred':
            ...
            delimiter = ' '
        elif parser.dataset=='eth_sub':
            label_path = f'{data_root}/eth/{seq_name}.txt'
            delimiter = ' '
        elif parser.dataset=='basketball':
        ...
        self.class_names = class_names = {'Pedestrian': 1, 'player' : 1, 'Car': 2, 'Cyclist': 3, 'Truck': 4, 'Van': 5, 'Tram': 6, 'Person': 7, \
