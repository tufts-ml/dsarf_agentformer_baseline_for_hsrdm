...
For reproducing the experiments for classifying system-states, run the model [here](https://github.com/tufts-ml/dsarf_agentformer_baseline_for_hsrdm/tree/kgili/dsarf_on_marching/run_marchingband.py) and plot the results [here](https://github.com/tufts-ml/dsarf_agentformer_baseline_for_hsrdm/tree/kgili/dsarf_on_marching/plot_results.ipynb)
